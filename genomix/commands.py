...
COMMAND_DESCRIPTIONS = {
    ...
    "/prioritize": "Filter and prioritize variants from large VCFs",
    "/compare": "Compare VCFs (trio, tumor-normal)",
...
COMMAND_SECTIONS = [
    ...
    ("Clinical", ["/report", "/drug", "/disease", "/frequency", "/classify", "/pgx-profile", "/prioritize", "/compare"]),
    ("Oncology", ["/cancer"]),
